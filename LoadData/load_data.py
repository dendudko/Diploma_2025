...
def dev_process_data(df_data, df_marine, data_file_name, interpolation: bool, max_gap_minutes: int = 30):
...
if __name__ == '__main__':
    ...
    dev_process_data(dfd, dfm, 'all_merged_inter.xlsx', True)
    dev_process_data(dfd, dfm, 'all_merged_no_inter.xlsx', False)
